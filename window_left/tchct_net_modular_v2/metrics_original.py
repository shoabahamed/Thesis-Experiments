...
This module preserves the original notebook behaviour for baseline
comparison and reproducing the published reference numbers.

Known issues inherited from the notebook baseline:
