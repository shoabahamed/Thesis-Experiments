...
if __name__ == "__main__":
    import torch
    print("=" * 60)
    print("THCT-Net Leap Motion — non-causal check")
    print("=" * 60)
    ...
    print(f"Input  : {tuple(sequences.shape)}  (B, T, D)  — matches DataLoader output [OK]")
    print(f"Output : {tuple(logits.shape)}  (B, num_classes) [OK]")
