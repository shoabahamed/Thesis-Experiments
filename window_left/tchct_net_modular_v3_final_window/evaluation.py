...
Provides:
  ...
  - evaluate_streaming_metrics   : SHREC'21 streaming metrics (DR, FPR, Jaccard)
                                   using the corrected SHREC'21 metrics module
"""
...
def evaluate_streaming_metrics(
    ...
    into the format expected by ``metrics_corrected``, and accumulates
    results globally. Call ``print_streaming_metrics_results`` afterwards
    to display.
    ...
    print(f"Running: {'corrected' if run_corrected else 'none'}")
    print()
