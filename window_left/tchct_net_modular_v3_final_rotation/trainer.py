...
def train_model(
    ...
    for epoch in range(1, epochs + 1):
        # Advance the batch sampler's epoch so each epoch draws a fresh
        # class-balanced subset of windows (otherwise _epoch stays 0 and
        # every epoch reuses the identical batch composition).
