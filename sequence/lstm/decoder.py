...
frame-by-frame inference with the LSTM model.

**CAUTION**: The logic in _BagAggregator, SimplifiedBagDecoder, and
stream_lstm_online is the core inference engine. Any changes here will
...
Provides:
  ...
  - stream_lstm_online     : frame-by-frame LSTM streaming inference
"""
